...
actor ToolRegistry {
    ...
    private static let toolGroups: [String: (keywords: [String], tools: [String])] = [
        ...
        "memory": (["remember", "memory", "recall", "forget", "what do you know", "last time", "previously", "we talked", "we discussed", "talk about last", "talked about", "discussed last", "earlier we", "yesterday", "last week", "before", "history", "past conversation", "what did we", "did we talk", "previous chat", "earlier chat", "last chat"], ["memory_save", "memory_recall", "memory_search", "memory_forget", "recall_episodes"]),
        ...
        "skills": (["weather", "forecast", "temperature outside", "calculate", "math", "convert", "units", "how many days", "days until", "days between", "define", "definition", "meaning of", "dashboard", "system health", "what am i doing", "what's on my screen right now", "what app", "what's open", "current context", "ambient"], ["weather_lookup", "calculator", "unit_convert", "date_calc", "define_word", "system_dashboard", "ambient_context"]),
