...
actor ToolRegistry {
    ...
    private static let toolGroups: [String: (keywords: [String], tools: [String])] = [
        ...
        "memory": (["remember", "memory", "recall", "forget", "what do you know", "last time", "previously", "we talked about", "earlier we", "yesterday", "last week", "before", "history", "past conversation"], ["memory_save", "memory_recall", "memory_search", "memory_forget", "recall_episodes"]),
