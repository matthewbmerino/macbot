...
actor ToolRegistry {
    ...
    private static let toolGroups: [String: (keywords: [String], tools: [String])] = [
        ...
        "web": (["search", "look up", "find out", "what is", "who is", "latest", "news", "current", "today", "right now", "how much", "price of", "cost of", "weather", "bitcoin", "btc", "crypto", "ethereum", "eth"], ["web_search", "fetch_page"]),
        "files": (["file", "read", "write", "folder", "directory", "create file"], ["read_file", "write_file", "list_directory", "search_files"]),
        "chart": (["chart", "graph", "plot", "visualize", "diagram", "show me", "display", "trend", "performance", "over time", "history", "historical", "ytd", "year to date", "monthly", "weekly", "daily"], ["stock_chart", "generate_chart"]),
